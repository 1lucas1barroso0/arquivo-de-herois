...
function effectSummary(id: string) {
  const summaries: Record<string, string> = {
    ...
    burrowing: "Escava através do solo na velocidade da graduação do efeito.",
    communication: "Permite comunicação à distância por um meio sensorial escolhido.",
    comprehend: "Permite compreender, e conforme a configuração comunicar-se com, linguagens ou formas incomuns de informação.",
    concealment: "Concede ocultação contra um ou mais tipos de sentido.",
    counter: "Neutraliza outros efeitos por oposição de graduações.",
    create: "Cria objetos sólidos com volume e Robustez determinados pela graduação.",
    damage: "Causa condições de dano resistidas por Robustez.",
    "dimensional-travel": "Transporta o personagem entre dimensões ou planos definidos.",
    elongation: "Estende o corpo para aumentar alcance e interagir à distância.",
    "enhanced-movement": "Adiciona adaptações e capacidades especiais aos modos de movimento.",
    "enhanced-resistance": "Aumenta uma resistência ou aplica modificadores às graduações já existentes.",
    "enhanced-senses": "Acrescenta ou aprimora qualidades dos sentidos.",
    "enhanced-strength": "Aumenta Força e pode separar seus benefícios de dano e capacidade física.",
    "enhanced-trait": "Aumenta um traço escolhido.",
    environment: "Altera condições ambientais como luz, calor, frio ou impedimentos dentro de uma área.",
    "extra-limbs": "Concede membros funcionais adicionais e benefícios relacionados a agarrar e manipular.",
    feature: "Representa uma utilidade menor e específica que não cabe em outro efeito.",
    flight: "Concede movimento aéreo na velocidade da graduação.",
    "fortune-control": "Altera resultados de sorte e o uso de recursos heroicos conforme a configuração.",
    growth: "Aumenta o tamanho e aplica o pacote de alterações configurado para a forma ampliada.",
    healing: "Remove condições de dano e pode receber opções para outros tipos de recuperação.",
    illusion: "Produz impressões sensoriais falsas que podem chegar a condições de alucinação.",
    immortality: "Permite retornar da condição Morto após um intervalo definido pela graduação.",
    immunity: "Ignora por completo efeitos, descritores ou perigos escolhidos dentro do custo adquirido.",
    insubstantial: "Transforma o corpo em estado menos material, com capacidades e vulnerabilidades próprias.",
    leaping: "Aumenta as graduações de distância dos saltos.",
    lifting: "Soma graduações à Força apenas para erguer, carregar e arremessar massa.",
    "mind-reading": "Obtém informação mental de um alvo mediante resistência e graus de sucesso.",
    morph: "Altera a aparência física dentro do conjunto de formas adquirido.",
    "move-object": "Exerce força à distância para mover, erguer, agarrar ou arremessar objetos.",
    obscure: "Cria uma área que bloqueia ou dificulta tipos de sentido configurados.",
    permeate: "Permite atravessar matéria sólida até a velocidade limitada pelo efeito.",
    postcognition: "Revela impressões de acontecimentos passados, conforme informação fornecida pelo Narrador.",
    precognition: "Revela possibilidades futuras, sempre sujeitas a mudança e à informação do Narrador.",
    quickness: "Reduz o tempo necessário para tarefas rotineiras que possam ser aceleradas.",
    regeneration: "Remove condições Ferido mais rapidamente e acelera a recuperação de dano.",
    "remote-sensing": "Desloca o ponto de percepção dos sentidos escolhidos para outro local.",
    shrinking: "Reduz o tamanho e aplica o pacote de alterações configurado para a forma menor.",
    "space-travel": "Permite percorrer distâncias astronômicas fora da escala de movimento comum.",
    speed: "Soma graduações à velocidade de deslocamento terrestre.",
    summon: "Traz um ou mais auxiliares construídos com as graduações do efeito.",
    swimming: "Soma graduações à velocidade de natação e melhora seu uso.",
    swinging: "Move o personagem por cabos, teias ou suportes equivalentes até a distância adquirida.",
    teleport: "Transpõe instantaneamente a distância da graduação sem cruzar o espaço intermediário.",
    transmute: "Transforma materiais ou objetos em outras substâncias conforme a configuração.",
